...
<?php wp_body_open(); ?>
	...
	<header class="header" id="header">
		<div class="header__inner container">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="header__logo" aria-label="<?php bloginfo( 'name' ); ?> トップへ">FORT</a>

			<div class="header__right">
				<?php if ( is_front_page() ) : ?>
				<!-- トップページ用のナビ項目（PCで表示・スマホでは目次MENUに集約） -->
				<nav class="header-nav" aria-label="主要メニュー">
					<a href="#concept" class="header-nav__link"><span class="header-nav__en">CONCEPT</span><span class="header-nav__ja">FORTの考え方</span></a>
					...
					<a href="<?php echo esc_url( get_post_type_archive_link( 'fort_event' ) ); ?>" class="header-nav__link"><span class="header-nav__en">EVENT</span><span class="header-nav__ja">イベント</span></a>
				</nav>
				<?php endif; ?>
